...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
				...
				<li class="nav-item dropdown"><a class="nav-link"
					...
					<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
						<a href="#" class="dropdown-item"> <!-- Message Start -->
							<div class="media">
								<img src="<c:url value="dist/img/user1-128x128.jpg"/> "
						...
						<a href="#" class="dropdown-item"> <!-- Message Start -->
							<div class="media">
								<img src="<c:url value="dist/img/user8-128x128.jpg"/>"
		...
		<footer class="main-footer">
			<strong>Copyright &copy; 2014-2021 <a
				href="<c:url value="https://adminlte.io"/>">AdminLTE.io</a>.
	...
	<script>
		function deleteVideo(href) {
			$.ajax({
				url: '/ASM-Java4-2023/admin/video?action=delete&href=' + href
			}).then(function (data) {
				window.location.href = "http://localhost:8080/ASM-Java4-2023/admin/video?action=view";
			}).fail(function (error){
					alert("Error");
			})
		};
